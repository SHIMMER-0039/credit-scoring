...
for train_proportion in train_proportions:
    ...
    # Train the models using Adaptive Bayesian Stacking with homogeneous LightGBM models
    base_models = [
...
results_file_path = os.path.join(save_path, 'fannie_AAESS_train_proportion_auc_results_with_features.pickle')
