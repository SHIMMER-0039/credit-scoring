...
def plot_curves(file_paths, labels, save_path=None):
    colors = ['b', 'g', 'r', 'c', 'm', 'y', 'k', 'orange', 'purple', 'brown', 'gold']
...
file_paths = [
    r'D:\study\second\outcome\bankfear\other_method\lr_bankfear_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\lda_bankfear_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\dt_bankfear_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\knn_bankfear_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\adaboost_bankfear_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\rf_bankfear_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\gbdt_bankfear_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\xgb_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\lgb_res.pickle',
    r'D:\study\second\outcome\bankfear\other_method\mg-gbdt_bankfear_res.pickle',  
    r'D:\study\second\outcome\bankfear\other_method\AAESS_res.pickle'              
]

labels = ['LR', 'LDA', 'DT', 'KNN', 'Adaboost', 'RF',
          'gbdt', 'XGB', 'LGB', 'MG-GBDT', 'AAESS']

plot_curves(file_paths, labels,
            save_path=r"D:\study\second\picture\compare\bankfear.png")
