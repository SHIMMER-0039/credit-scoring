...
def plot_curves(file_paths, labels, save_path=None):
    colors = ['b', 'g', 'r', 'c', 'm', 'y', 'k', 'orange', 'purple', 'brown', 'gold', 'deeppink']
    ...
    for i, file_path in enumerate(file_paths):
        ...
        if fprs is not None and tprs is not None:
            line_style = '--' if labels[i].upper() in ['LDA', 'LR', 'GBDT', 'RF', 'NN', 'XGB'] else '-'
...
file_paths = [
    r'D:\study\second\outcome\fannie\lr_res.pickle',
    r'D:\study\second\outcome\fannie\lda_res.pickle',
    r'D:\study\second\outcome\fannie\dt_res.pickle',
    r'D:\study\second\outcome\fannie\knn_res.pickle',
    r'D:\study\second\outcome\fannie\adaboost_res.pickle',
    r'D:\study\second\outcome\fannie\rf_res.pickle',
    r'D:\study\second\outcome\fannie\gbdt_res.pickle',
    r'D:\study\second\outcome\fannie\xgb_res.pickle',
    r'D:\study\second\outcome\fannie\lgb_res.pickle',
    r'D:\study\second\outcome\fannie\AAESS_res.pickle',
    r'D:\study\second\outcome\fannie\mg-gbdt_res.pickle'   
]

labels = ['LR', 'LDA', 'DT', 'KNN', 'Adaboost', 'RF', 'gbdt', 'XGB', 'LGB', 'AAESS', 'MG-GBDT']  

plot_curves(file_paths, labels,
            save_path=r"D:\study\second\picture\compare\fannie.png")
